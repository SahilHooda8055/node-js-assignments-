/*
While working with the events module, one interesting is that when an event is created and
called, the associated event handler is triggered However, what happens if we remove an event and then
try to call it? In this coding challenge lets create an event handler and call it Later let's remove the event handler and observe what happens when we call it.
*/
